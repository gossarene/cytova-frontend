        ...
        <Card className="lg:col-span-2">
          ...
          <CardContent className="space-y-3 text-sm">
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              {(invoice.generated_by_display || invoice.generated_by_email) && (
                <Field
                  label="Generated by"
                  value={invoice.generated_by_display || invoice.generated_by_email!}
                />
              )}
              {invoice.confirmed_at && (
                <Field label="Confirmed" value={formatDateTime(invoice.confirmed_at)} />
              )}
              {(invoice.confirmed_by_display || invoice.confirmed_by_email) && (
                <Field
                  label="Confirmed by"
                  value={invoice.confirmed_by_display || invoice.confirmed_by_email!}
                />
              )}
            </div>
          </CardContent>
